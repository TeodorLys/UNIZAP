...
const std::string types::s_types[types::size_of_array]{ "ACCESS", "DIR_PATH", "FILES", "FLAGS", "ZIP_NAME", "UPLOAD_PATH"};  // UNUSED
const std::string predefined_literals::s_predefined_literals[predefined_literals::size_of_array]{ "INCLUDE_DIRECTORY", "FORCE", "DISABLE_CONFIRM_CURL" };
